...
export default function DashboardError({ error, reset }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-3">Could not load your dashboard</h1>
      <p className="text-gray-500 text-sm mb-8 max-w-sm leading-relaxed">
        Something went wrong while loading your account overview. Your bookings and saved rooms are safe — try again or head to search.
      </p>
